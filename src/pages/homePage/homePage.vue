    ...
    <div class="content">
      ...
      <div class="content-item hot-live">
        <div class="title-wrapper">
          ...
          <div class="play-info">
            <div class="room"><span class="icon icon-room"></span>房间45</div>
            <div class="hot"><span class="icon icon-popularity"></span>人气100万</div>
          </div>
        </div>
          ...
          <ul class="room-list">
            <li class="room-item">
              ...
              <div class="room-item-footer">
                <div class="item fl"><span class="icon icon-teacher"></span>12</div>
                <div class="item"><span class="icon icon-renqi"></span>12</div>
                <div class="item fr"><span class="icon icon-room"></span>12</div>
              </div>
            </li>
          </ul>
        </div>
